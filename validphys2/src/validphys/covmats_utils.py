...
def diagonalize_fitting_covmat(
    dataset_inputs_fitting_covmat
):
    return la.eig(dataset_inputs_fitting_covmat)
...
def manipulate_fitting_covmat_eigs(
    dataset_inputs_fitting_covmat_eigs,
    num_turnoff
):
...
def reconstruct_manipulated_sampling_covmat(
...
def reconstruct_manipulated_fitting_covmat(
    dataset_inputs_fitting_covmat_eigs_manipulated
):
    eigval, eigvect = dataset_inputs_fitting_covmat_eigs_manipulated
    reconstructed = eigvect @ np.diag(eigval) @ eigvect.T
    return reconstructed.real