...
experiments_sampling_covmat_collection = collect(
...
def experiments_sampling_covmat_no_table(
...
@table
def procs_sampling_covmat(procs_sampling_covmat_no_table):
...
pdfs_datasets_chi2_data = collect("groups_datasets_chi2_data", ("pdfs",))

@table
def pdfs_datasets_chi2_table(
    pdfs,
    pdfs_groups,
...
pdfs_total_chi2_data = collect("total_chi2_data", ("pdfs", ))
